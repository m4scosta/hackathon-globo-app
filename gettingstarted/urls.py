...
urlpatterns = patterns('',
    ...
    url(r'^like/(?P<fb_id>\d+)/(?P<content_id>\d+)/$', recommendations.views.like, name='like'),
    url(r'^unlike/(?P<fb_id>\d+)/(?P<content_id>\d+)/$', recommendations.views.unlike, name='unlike'),
)
